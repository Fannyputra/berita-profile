                        ...
                        <?php if (!empty($section_services['item'])) { ?>
                            <?php foreach ($section_services['item'] as $item) { ?>
                                <div class="col-lg-3 mb-4 col-py-10">
                                    ...
                                    ?>
                                    <div href="<?php echo $url_link; ?>" class="card card-border h-100 icon-grid grid-slide-up">
                                        <h1 href="<?php echo $url_link; ?> class=" text-center icon-header">
                                        ...
                                        <div class="card-body text-center icon-body">
                                            <a href="<?php echo $url_link; ?>">
                                                <small class="icon-title" style="background: -webkit-gradient(linear, left bottom, right top, from(orange), color-stop(50%,red), color-stop(50%,orange)); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"><?php echo $item['judul']; ?></small>
                                            </a>
                                        </div>
                                    </div>
                                </div>
